...
typedef struct {
    ...
    bool keep_conditioner_resident;  // Keep the conditioner runner warm; auto-fit may reclaim it under pressure
...
enum sd_generation_phase_t {
    SD_PHASE_PREPARING = 0,
    SD_PHASE_ENCODING_INPUT,
    SD_PHASE_ENCODING_PROMPT,
    SD_PHASE_DENOISING,
    SD_PHASE_DECODING,
    SD_PHASE_FINALIZING,
    SD_PHASE_COUNT,
